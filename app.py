...
with left_col:
    ...
    canvas_result = st_canvas(stroke_width=20,stroke_color="white",background_color="#000000",width=400,height=400,display_toolbar=False)
    ...
    elif clear_btn and len(canvas_result.json_data.get("objects")) > 0:
        pass
